...
<head>
    <meta charset="UTF-8">
    <title>Editar MMDVMPLUS.ini</title>
...
<div class="row">
  <div class="col-6 offset-3 text-center">
    <span class="text-center color_font_Bebas_azul">Editar&nbsp;&nbsp;&nbsp;&nbsp;</span>
...
<!-- <hr class="linea-blanca"> -->
    ...
    <?php
    $filePath = "/home/pi/MMDVMHost/MMDVMPLUS.ini";
...
document.querySelectorAll('.editable').forEach(td => {
    td.addEventListener('dblclick', () => {
        ...
        const guardarCambio = () => {
            ...
            fetch('editar_lineas_dmrplus.php', {
                method: 'POST',
